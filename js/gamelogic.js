...
var Class = {
  create: function(prototype) { // создание "класса" (конструктор с прототипом)
...
Game = {
    ...
    run: function (options) {
        ...
        var now,
            ...
            fpsmeter = new FPSMeter(options.fpsmeter || { decimals: 0, graph: true, theme: 'transparent', top: '-500px', left: '-500px' }); //фиговина для подсчёта FPS, важно для отрисовки
...
//-------------------------------------------------------------------------
// ЗАГРУЗКА ВСЯКОЙ ВСЯЧИНЫ
//-------------------------------------------------------------------------

Game.Load = {

  images: function(names, callback) { // загрузка сразу нескольких изображений, колбек, когда загружены все
...
//-------------------------------------------------------------------------
// ВСПОМОГАТЕЛЬНАЯ МАТЕМАТИКА ИГРЫ
//-------------------------------------------------------------------------
